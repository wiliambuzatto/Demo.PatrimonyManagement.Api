...
{
    public class RepositoryPattern<TEntity> : IRepositoryPattern<TEntity> where TEntity : class
    {
        ...
        public async Task<TEntity> FindAsync(IncludeList<TEntity> includes, Expression<Func<TEntity, bool>> filter)
        {
            ...
            if (count > 1)
                throw new PatrimonyManagementException("Mais de uma entidade foi retornada, usando o filtro específico.");
        ...
        public async Task DeleteAsync(params object[] keyValues)
        {
            ...
            if (entity == null)
                throw new PatrimonyManagementException(Error.NotFound);
